...
public class PrescriptionService {
    ...
    public ResponseEntity<String> savePrescription(Prescription prescription) {
        try {
            ...
            if (result.isEmpty()) {
                ...
                return new ResponseEntity<>("Prescription saved", HttpStatus.OK);
            } else {
                return new ResponseEntity<>("Prescription already exists", HttpStatus.BAD_GATEWAY);
            }
        } catch (Exception e) {
    ...
    public ResponseEntity<Map<String, Object>> getPrescription(Long appointmentId) {
        ...
        try {
            ...
            if (result.isEmpty()) {
                map.put("err", "No Precription found with given appointment ID");
                return new ResponseEntity<>(map, HttpStatus.BAD_REQUEST);
            }
            map.put("prescription", result);
