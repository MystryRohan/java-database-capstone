...
public class Login {
    ...
    // - The email field is expected to contain a valid email address for user
    ...
    // - It is generally hashed before being stored and compared during
    // authentication.
    ...
    // - Standard getter and setter methods are provided for both 'email' and
    // 'password' fields.
